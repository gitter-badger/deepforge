...
/**
 * Generated by PluginGenerator 0.14.0 from webgme on Fri Sep 11 2015 17:47:21 GMT-0500 (CDT).
 */

'use strict';
var testFixture = require('../../globals');

describe('NetworkImporter', function () {
    var gmeConfig = testFixture.getGmeConfig(),
        expect = testFixture.expect,
        logger = testFixture.logger.fork('NewPlugin'),
        PluginCliManager = testFixture.WebGME.PluginCliManager,
        projectName = 'CXXNet',
        pluginName = 'NetworkImporter',
        project,
        gmeAuth,
        storage,
        commitHash;

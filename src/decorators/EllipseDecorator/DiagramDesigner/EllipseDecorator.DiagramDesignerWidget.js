...
define([
    ...
    'text!./EllipseDecorator.DiagramDesignerWidget.html',
    'css!./EllipseDecorator.DiagramDesignerWidget.css'
], function (CONSTANTS, nodePropertyNames, DiagramDesignerWidgetDecoratorBase, EllipseDecoratorTemplate) {
    ...
    EllipseDecorator.prototype.$DOMBase = $(EllipseDecoratorTemplate);
    ...
    EllipseDecorator.prototype.getConnectionAreas = function (id /*, isEnd, connectionMetaInfo*/) {
        var result = [],
            edge = 10,
            LEN = 20;
